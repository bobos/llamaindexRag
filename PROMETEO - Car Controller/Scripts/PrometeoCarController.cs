...
public class PrometeoCarController : MonoBehaviour
{
    ...
    void OnCollisionEnter(Collision collision)
    {
        ...
        // 只检测标记为障碍物的碰撞
        if (!collision.gameObject.CompareTag("ground") && !collision.gameObject.CompareTag(finishLineTag))
        {
    ...
    public void DecelerateCar(){
      ...
      carRigidbody.linearVelocity = carRigidbody.linearVelocity * (1f / (1f + (0.025f * 20)));
